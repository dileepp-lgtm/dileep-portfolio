...
/* Port of the React Bits <ShapeBlur />. A rounded-rect SDF border that is
   revealed by a soft circle following the pointer. Adaptations for this site:
   - a u_color uniform so the reveal can match the brand accent
   - pixelRatio capped and rendering paused while off-screen (there is one
     instance per tool box, so this keeps a grid of them cheap). */
...
export default function ShapeBlur({
  ...
  useEffect(() => {
    ...
    /* pause the render loop while the box is scrolled out of view */
